...
<ul>
   <li style="margin-bottom: 40px;">
        ...
        <img src="https://res.cloudinary.com/dojcchveo/image/upload/v1719696543/cevl4rhxesvz5h60kwnx.png" alt="Home Page" width="80%">
    </li>
    <li style="margin-bottom: 40px;">
        ...
        <img src="https://res.cloudinary.com/dojcchveo/image/upload/v1719697079/baccabucci/bep4ettcchtxxdwywkbc.png" alt="Cart Page" width="80%">
    </li>
    <li style="margin-bottom: 40px;">
        ...
        <img src="https://res.cloudinary.com/dojcchveo/image/upload/v1719697528/baccabucci/vijejmoowdawu7ouvfbf.png" alt="Discover Section" width="80%">
    </li>
    <li style="margin-bottom: 40px;">
        <p>Here we recreated the category section where you can find all the category products of Bacca Bucci.</p>
        <img src="https://res.cloudinary.com/dojcchveo/image/upload/v1719697873/baccabucci/vcbpbnv1xgku5qrvwwz9.png" alt="Categoty Section" width="80%">
    </li>
    <li style="margin-bottom: 40px;">
        <p>This is our Best Sellers section. Here We using Swiper for smooth sliding effects.</p>
        <img src="https://res.cloudinary.com/dojcchveo/image/upload/v1719698085/baccabucci/cgksbirobq8ebiuw9tev.png" alt="Categoty Section" width="80%">
    </li>
    <li style="margin-bottom: 40px;">
        ...
        <img src="https://res.cloudinary.com/dojcchveo/image/upload/v1719698342/baccabucci/s2zein322zyftzf2qgbp.png" alt="Categoty Section" width="80%">
    </li>
    <li style="margin-bottom: 40px;">
        ...
        <img src="https://res.cloudinary.com/dojcchveo/image/upload/v1719698646/baccabucci/kvtvm8hmmu7zm18d2nlb.png" alt="Categoty Section" width="80%">
    </li>
    <li style="margin-bottom: 40px;">
        <p>This is the month's featured item. Here we Using Slider for shoe image sliding.</p>
        <img src="https://res.cloudinary.com/dojcchveo/image/upload/v1719698913/baccabucci/q2srgwa6mjjjwn09epmi.png" alt="Categoty Section" width="80%">
    </li>
    <li style="margin-bottom: 40px;">
        <p>This is the Season Product section.</p>
        <img src="https://res.cloudinary.com/dojcchveo/image/upload/v1719699219/baccabucci/wh9ngq1sfojgoevx3gs6.png" alt="Categoty Section" width="80%">
    </li>
    <li style="margin-bottom: 40px;">
        <p>At last but not the least this is our footer section.</p>
        <img src="https://res.cloudinary.com/dojcchveo/image/upload/v1719699398/baccabucci/a1ra4sqj8cdvpxyxxlgu.png" alt="Categoty Section" width="80%">
        <img src="https://res.cloudinary.com/dojcchveo/image/upload/v1719699397/baccabucci/nntff1nxs7fwrlpe4jay.png" alt="Categoty Section" width="80%">
    </li>
</ul>
